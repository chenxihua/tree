...
/**
 * @ClassName: BuildTreeUtil2
 * @Create By: chenxihua
 * @Author: Administrator
 * @Date: 2019/12/4 15:04
 *
 *
 * 这里使用第二种方式，注入spring里面的
 *
 **/
@Component
public class BuildTreeUtil2 {
     ...
     */
    public void getInstance(List<DevTreeNode> allDevTreeNodes){
        this.domainNodes = domainRepository.findAll();
        this.deviceNodes = deviceRepository.findAll();
